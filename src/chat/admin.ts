...
export default function registerAdminRoutes(main: Main, router: Router) {
  ...
  const commands = [
    ...
    {name: 'Update pubsub', method: main.ytPubSub.updateSubscribes},
    {name: 'Clean chats & channels & videos', method: main.checker.clean},
    {name: 'Clean pubsub', method: main.ytPubSub.clean},
  ];
