...
const pageBtnList = (query: {
  [s: string]: any
}, btnList: TelegramBot.InlineKeyboardButton[][], command: string, _middleBtn?: TelegramBot.InlineKeyboardButton | TelegramBot.InlineKeyboardButton[]) => {
